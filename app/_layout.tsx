    ...
    <ReservationProvider>
      <ThemeProvider value={colorScheme === "dark" ? DarkTheme : DefaultTheme}>
        <Stack>
          ...
          <Stack.Screen name="components/login/index" options={{ title: "" ,headerShown: false}} />
          ...
          <Stack.Screen name="components/reservation/datereservation" options={{ title: "",headerShown: false }} />
          ...
          <Stack.Screen name="components/infoapp/aboutapplication" options={{ title: "" }} />
        </Stack>
